        ...
        <div className="overflow-x-auto">
          <div className="inline-block min-w-full">
            <table className="w-full border-collapse">
              <thead>
                <tr>
                  <th className="sticky left-0 z-10 bg-muted/50 backdrop-blur-sm border-b border-r px-4 py-3 text-left text-sm font-semibold min-w-[150px]">
                    Employee
                  </th>
                  {projects.map((project) => (
                    <th
                      key={project.name}
                      className="border-b px-4 py-3 text-center text-sm font-semibold min-w-[120px] bg-muted/30"
                    >
              ...
              <tbody>
                {employees.map((employee, empIndex) => (
                  <tr key={employee} className="hover:bg-muted/20 transition-colors">
                    <td className="sticky left-0 z-10 bg-card backdrop-blur-sm border-r px-4 py-3 text-sm font-medium">
