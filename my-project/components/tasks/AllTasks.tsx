  ...
  */
  ...
  const completionModalContent = completionModalOpen && taskToComplete && (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-[9999] p-4">
      <div className="bg-card border border-border p-8 rounded-2xl shadow-xl w-full max-w-4xl animate-in zoom-in duration-300 relative z-[10000] max-h-[90vh] overflow-y-auto custom-scrollbar">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Left Column: Task Details and Action Form */}
